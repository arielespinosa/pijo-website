...
const senses = [
  {
    icon: Ear,
    title: "Esc\u00facha el crujido",
    description: "Cada patata crujen con una intensidad que solo la elaboraci\u00f3n artesanal consigue. Un sonido inconfundible.",
    stat: "140dB",
  ...
  },
  {
    ...
    description: "Saborizantes naturales y recetas de autor. Cada mordisco es un viaje gustativo completo.",
    stat: "100%",
  ...
  },
  {
    ...
    description: "El efecto PIJO: una vez que pruebas, no hay vuelta atr\u00e1s. Lo dicen nuestros 2.400+ fans.",
    stat: "97%",
        ...
        >
          {senses.map((sense, i) => {
            ...
            return (
              <div
                key={i}
                className="group relative overflow-hidden rounded-2xl border border-foreground/[0.06] p-8 transition-all duration-500 hover:border-foreground/12"
                style={{
              ...
              >
                {/* Hover glow */}
                <div
                  className="pointer-events-none absolute -top-20 -right-20 h-40 w-40 rounded-full opacity-0 blur-[50px] transition-opacity duration-700 group-hover:opacity-100"
                ...
                <p className="mb-6 text-sm leading-relaxed text-foreground/50">{sense.description}</p>
